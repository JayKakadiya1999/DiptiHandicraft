...
?>
	...
	<div class="container" style=" margin-top: 30px;">
			...
			?>
				...
				<div class="" style="border: 1px solid black; padding: 10px; border-radius: 25px;margin-bottom: 30px">
						<div class="row">
							<div class="col-lg-3">
								<div class="product-card" style="text-align: left;">
		        					<img src="{{ $rows->Path }}" class="img-fluid product-img" style="width: 250px; height: 250px; margin-left: 10px; margin-top: 10px;">
		        					<h1 style="color: #3f4b5d; margin-top: 10px; margin-left: 10px;">{{ $rows->Product_name }}</h1> 
		        				</div>
							</div>
							<div class="col-lg-4">
		        					<div class="rating_container">
										<div class="feedback">
										   	<div class="rating">
											    <input type="radio" name="rating" id="rating-5" value="5" onclick="rating(this.value)">
											    <label for="rating-5"></label>
										      <input type="radio" name="rating" id="rating-4" value="4" onclick="rating(this.value)">
										      <label for="rating-4"></label>
										      <input type="radio" name="rating" id="rating-3" value="3" onclick="rating(this.value)">
										      <label for="rating-3"></label>
										      <input type="radio" name="rating" id="rating-2" value="2" onclick="rating(this.value)">
										      <label for="rating-2"></label>
										      <input type="radio" name="rating" id="rating-1" value="1" onclick="rating(this.value)">
										...
										<form action="{{ route('rating') }}" method="post">
											{{ csrf_field() }}
											<input type="text" name="id" style="display: none;" value="{{ $rows->Product_id }}">
											<input type="text" name="rates" id="rates" value="0" style="display: none;">
											<button class="btn btn-warning" style="margin-left: 66px; width: 200px;">Go</button>
										</form>
		        			</div>
		        		...
		        		@if($totalrating != null)
		        			<div class="col-lg-4">
								<div style="border: 1px solid black; margin-top: 10px; padding-left: 10px; padding-bottom: 10px;">
									<span style="font-weight: bold;">{{ $outofrate }} out of 5 star</span><br>
						...
						@endif
							...
							<!-- Rating -->
		        		<div class="review_list" style="margin-bottom: 30px">
